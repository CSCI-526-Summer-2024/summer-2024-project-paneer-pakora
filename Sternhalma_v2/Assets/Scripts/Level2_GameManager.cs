...
public class Level2_GameManager : MonoBehaviour
{
    ...
    public static Level2_GameManager Instance;
    ...
    public void GenerateHexGrid(float hexSize, Dictionary<Vector3, HexTile> posTile, Dictionary<Vector3, Vector3> posTranslator, HexTile hexPrefab)
    {
        ...
        Level2_GameManager.Instance.ChangeState(GameState.SpawnObjects);
    }
    ...
    public void SpawnObjects(Dictionary<Vector3, BaseUnit> currentStatus, Dictionary<HexTile, BaseUnit> tileToUnit, HashSet<HexTile> isVisited)
    {
        ...
        List<Vector3> scissorList = new List<Vector3> { new Vector3(1.5f, 0.5f),new Vector3(0f,-1f) };
        ...
        List<Vector3> paperList = new List<Vector3> { new Vector3(0f, 0f),  new Vector3(1.5f, -1.5f) };
        ...
        Level2_GameManager.Instance.ChangeState(GameState.PlayerTurn);
    }
}
